...
def letters_generator():
    ...
    # 0 nolla con
    consonants_nolla = ["B", "C", "Ć", "D", "F", "G", "H", "J", "K", "L", "Ł", "M", "N", "Ń", "P", "R", "S", "Ś", "T",
                        "W", "Z", "Ź", "Ż"]

    random_consonants_nolla = random.choice(consonants_nolla)

    # 1 yksi con
    consonants_yksi = ["B", "C", "Ć", "D", "F", "G", "H", "J", "K", "L", "Ł", "M", "N", "Ń", "P", "R", "S", "Ś", "T",
                       "W", "Z", "Ź", "Ż"]

    random_consonants_yksi = random.choice(consonants_yksi)

    # 2 kaksi con
    consonants_kaksi = ["B", "C", "Ć", "D", "F", "G", "H", "J", "K", "L", "Ł", "M", "N", "Ń", "P", "R", "S", "Ś", "T",
                        "W", "Z", "Ź", "Ż"]

    random_consonants_kaksi = random.choice(consonants_kaksi)

    # 3 kolme con
    consonants_kolme = ["B", "C", "Ć", "D", "F", "G", "H", "J", "K", "L", "Ł", "M", "N", "Ń", "P", "R", "S", "Ś", "T",
                        "W", "Z", "Ź", "Ż"]

    random_consonants_kolme = random.choice(consonants_kolme)

    # 4 nelja con
    consonants_nelja = ["B", "C", "Ć", "D", "F", "G", "H", "J", "K", "L", "Ł", "M", "N", "Ń", "P", "R", "S", "Ś", "T",
                        "W", "Z", "Ź", "Ż"]

    random_consonants_nelja = random.choice(consonants_nelja)

    # 5 viisi con
    consonants_viisi = ["B", "C", "Ć", "D", "F", "G", "H", "J", "K", "L", "Ł", "M", "N", "Ń", "P", "R", "S", "Ś", "T",
                        "W", "Z", "Ź", "Ż"]

    random_consonants_viisi = random.choice(consonants_viisi)

    # 6 kuusi con
    consonants_kuusi = ["B", "C", "Ć", "D", "F", "G", "H", "J", "K", "L", "Ł", "M", "N", "Ń", "P", "R", "S", "Ś", "T",
                        "W", "Z", "Ź", "Ż"]

    random_consonants_kuusi = random.choice(consonants_kuusi)

    # 7 seitseman con
    consonants_seitseman = ["B", "C", "Ć", "D", "F", "G", "H", "J", "K", "L", "Ł", "M", "N", "Ń", "P", "R", "S", "Ś",
                            "T", "W", "Z", "Ź", "Ż"]

    random_consonants_seitseman = random.choice(consonants_seitseman)

    # 8 kahdeksan con
    consonants_kahdeksan = ["B", "C", "Ć", "D", "F", "G", "H", "J", "K", "L", "Ł", "M", "N", "Ń", "P", "R", "S", "Ś",
                            "T", "W", "Z", "Ź", "Ż"]
